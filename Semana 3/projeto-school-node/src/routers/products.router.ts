...
const products = [
    { 
        ...
        img: 'https://images.samsung.com/is/image/samsung/br-notebook-style-s51-np730xbe-kp1br-np730xbe-kp1br-fronttitanumsilver-185313138?$720_576_PNG$', price: 5000, 
        quantity: 5 
    }, 
    { 
        id: 2, 
    ...
    { 
        ...
        img: 'https://www.lojaasus.com.br/media/catalog/product/cache/e62f984c1b34771579d59f0076d196f0/0/0/00asus_laptop_x543_cinza_escuro_13_1_8.png', price: 3350, 
        quantity: 2 
    }
]
...
router.get('/:id', (req: Request, res: Response) => {
    const pdt = products.find(product => product.id.toString() === req.params.id)

    if (pdt == null || undefined) {
...
router.delete('/remove/:id', (req: Request, res: Response) => {
    ...
    if (productIndex === -1) {
        return res.status(400).send({ message: `Produto não encontrado para o id ${req.params.id}` })
    }
...
router.put('/update/:id', (req: Request, res: Response) => {
    ...
    res.status(200).send({ message: `Produto ${products[productIndex].description} atualizado com sucesso.`})
})
